      ...
      <div className={styles.background}>
        <section className={styles.section1}>
          <div className={styles.content}>
            ...
            <Image src="/images/background/church.jpg" width={600} height={400} alt="church" className={styles.image}/>
        ...
        <section className={styles.section2}>
          <div className={styles.content}>
            ...
            <Image src="/images/background/cold.jpg" width={600} height={400} alt="church" className={styles.image2}/>
        ...
        <section className={styles.section3}>
          <div className={styles.content}>
            ...
            <Image src="/images/background/ball.jpg" width={600} height={400} alt="church" className={styles.image3}/>
